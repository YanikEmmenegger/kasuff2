...
import {Answer, WordScrambleGame} from '../../../types';
...
const ResultWordScramble: React.FC = () => {
    ...
    const currentQuestion = currentRound?.data as WordScrambleGame
    ...
    return (
        <div className="w-full flex flex-col text-gray-200 p-8">
            <CollapsibleSection title={`Correct was: ${currentQuestion.word} - See answers`}>
